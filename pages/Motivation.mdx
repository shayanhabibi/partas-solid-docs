import { AnimatedShinyText } from "../dist/ui/text/AnimatedShinyText.fs.jsx";
import { AccordionExample } from "../dist/examples/MotivationPage.fs.jsx";
...
[Oxpecker.Solid](https://github.com/lanayx/oxpecker) that keeps the original DSL,
...
Below is the full code of the Accordion component from [solid-ui](https://solid-ui.com/docs/components/accordion)
(which itself is a [solid-js](https://solid-js.com) implementation of shadcn-ui) in JS.
